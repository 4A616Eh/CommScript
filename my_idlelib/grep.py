...
from my_idlelib.searchbase import SearchDialogBase
from my_idlelib import searchengine
...
class GrepDialog(SearchDialogBase):
    ...
    def default_command(self, event=None):
        ...
        if not path:
            self.top.bell()
            return
        from my_idlelib.outwin import OutputWindow  # leave here!
        save = sys.stdout
        try:
...
def _grep_dialog(parent):  # htest #
    ...
    from my_idlelib.pyshell import PyShellFileList
...
if __name__ == "__main__":
    ...
    main('my_idlelib.idle_test.test_grep', verbosity=2, exit=False)
