""" my_idlelib.config -- Manage IDLE configuration information.
...
class IdleConf:
    ...
    def CreateConfigHandlers(self):
        ...
        self.userdir = userdir = '' if my_idlelib.testing else self.GetUserCfgDir()
    ...
    def current_colors_and_keys(self, section):
        ...
        my_idlelib.config-main.def ('default') includes these sections
...
if __name__ == '__main__':
    ...
    main('my_idlelib.idle_test.test_config', verbosity=2, exit=False)
