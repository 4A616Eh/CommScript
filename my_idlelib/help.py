...
(help.copy_strip)=> Lib/ my_idlelib/help.html
...
def copy_strip():
    """Copy idle.html to  my_idlelib/help.html, stripping trailing whitespace.

    Files with trailing whitespace cannot be pushed to the git cpython
    repository.  For 3.x (on Windows), help.html is generated, after
    editing idle.rst on the master branch, with
      sphinx-build -bhtml . build/html
      python_d.exe -c "from my_idlelib.help import copy_strip; copy_strip()"
...
if __name__ == '__main__':
    ...
    main('my_idlelib.idle_test.test_help', verbosity=2, exit=False)
