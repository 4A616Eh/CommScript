...
from my_idlelib.autocomplete import FILES, ATTRS
from my_idlelib.multicall import MC_SHIFT
...
if __name__ == '__main__':
    ...
    main('my_idlelib.idle_test.test_autocomplete_w', verbosity=2, exit=False)
