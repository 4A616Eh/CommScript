...
from my_idlelib.config import idleConf, ConfigChanges
from my_idlelib.config_key import GetKeysDialog
from my_idlelib.dynoption import DynOptionMenu
from my_idlelib import macosx
from my_idlelib.query import SectionName, HelpSource
from my_idlelib.textview import view_text
...
from my_idlelib.format import FormatParagraph
from my_idlelib.squeezer import Squeezer
from my_idlelib.textview import ScrollableTextFrame
...
class HighPage(Frame):
    ...
    def create_page_highlight(self):
        ...
        complete listings called themes.  Built-in themes in
         my_idlelib/config-highlight.def are fixed as far as the dialog is
...
class KeysPage(Frame):
    ...
    def create_page_keys(self):
        ...
        keysets. Built-in keysets in  my_idlelib/config-keys.def are fixed
...
if __name__ == '__main__':
    ...
    main('my_idlelib.idle_test.test_configdialog', verbosity=2, exit=False)
