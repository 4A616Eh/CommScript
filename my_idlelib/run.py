...
f'''{sys.executable} -c "__import__('my_idlelib.run').run.main()"'''
'.run' is needed because __import__ returns  my_idlelib, not my_idlelib.run.
"""
import functools
import io
import linecache
...
import my_idlelib  # testing
from my_idlelib import autocomplete  # AutoComplete, fetch_encodings
from my_idlelib import calltip  # Calltip
from my_idlelib import debugger_r  # start_debugger
from my_idlelib import debugobj_r  # remote_object_tree_item
from my_idlelib import iomenu  # encoding
from my_idlelib import rpc  # multiple objects
from my_idlelib import stackviewer  # StackTreeItem
import __main__

import tkinter  # Use tcl and, if startup fails, messagebox.
if not hasattr(sys.modules['my_idlelib.run'], 'firstrun'):
    # Undo modifications of tkinter by  my_idlelib imports; see bpo-25507.
    ...
    sys.modules['my_idlelib.run'].firstrun = False
...
class Executive:
    ...
    def __init__(self, rpchandler):
        ...
        if my_idlelib.testing is False:
...
if __name__ == '__main__':
    ...
    main('my_idlelib.idle_test.test_run', verbosity=2)
