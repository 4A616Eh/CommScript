...
from my_idlelib.config import idleConf
from my_idlelib import configdialog
from my_idlelib import grep
from my_idlelib import help
from my_idlelib import help_about
from my_idlelib import macosx
from my_idlelib.multicall import MultiCallCreator
from my_idlelib import pyparse
from my_idlelib import query
from my_idlelib import replace
from my_idlelib import search
from my_idlelib.tree import wheel_event
from my_idlelib import window
...
class EditorWindow:
    from my_idlelib.percolator import Percolator
    from my_idlelib.colorizer import ColorDelegator, color_config
    from my_idlelib.undo import UndoDelegator
    from my_idlelib.iomenu import IOBinding, encoding
    from my_idlelib import mainmenu
    from my_idlelib.statusbar import MultiStatusBar
    from my_idlelib.autocomplete import AutoComplete
    from my_idlelib.autoexpand import AutoExpand
    from my_idlelib.calltip import Calltip
    from my_idlelib.codecontext import CodeContext
    from my_idlelib.sidebar import LineNumbers
    from my_idlelib.format import FormatParagraph, FormatRegion, Indents, Rstrip
    from my_idlelib.parenmatch import ParenMatch
    from my_idlelib.squeezer import Squeezer
    from my_idlelib.zoomheight import ZoomHeight
    ...
    def __init__(self, flist=None, filename=None, key=None, root=None):
        ...
        from my_idlelib.runscript import ScriptBinding
...
##        self.reset_help_menu_entries()
    ...
    def open_module_browser(self, event=None):
        ...
        if not (self.__class__.__name__ == 'PyShellEditorWindow'
            ...
            if filename is None:
                return "break"
        from my_idlelib import browser
        browser.ModuleBrowser(self.root, filename)
        return "break"

    def open_path_browser(self, event=None):
        from my_idlelib import pathbrowser
    ...
    def ispythonsource(self, filename):
        ...
        if os.path.normcase(ext) in (".py", ".pyw", ".cs"):       #20210724 for CommScript
            return True
...
if __name__ == '__main__':
    ...
    main('my_idlelib.idle_test.test_editor', verbosity=2, exit=False)

    from my_idlelib.idle_test.htest import run
    run(_editor_window)
