...
if __name__ == "__main__":
    sys.modules['my_idlelib.pyshell'] = sys.modules['__main__']
...
if TkVersion < 8.5:
    ...
    root.withdraw()
    from my_idlelib.run import fix_scaling
    fix_scaling(root)
...
from my_idlelib.colorizer import ColorDelegator
from my_idlelib.config import idleConf
from my_idlelib import debugger
from my_idlelib import debugger_r
from my_idlelib.editor import EditorWindow, fixwordbreaks
from my_idlelib.filelist import FileList
from my_idlelib.outwin import OutputWindow
from my_idlelib import rpc
from my_idlelib.run import idle_formatwarning, StdInputFile, StdOutputFile
...
class ModifiedInterpreter(InteractiveInterpreter):
    ...
    def build_subprocess_arglist(self):
        ...
        command = "__import__('my_idlelib.run').run.main(%r)" % (del_exitf,)
    ...
    def remote_stack_viewer(self):
        from my_idlelib import debugobj_r
        oid = self.rpcclt.remotequeue("exec", "stackviewer", ("flist",), {})
        if oid is None:
            self.tkconsole.root.bell()
            return
        item = debugobj_r.StubObjectTreeItem(self.rpcclt, oid)
        from my_idlelib.tree import ScrolledCanvas, TreeNode
...
class PyShell(OutputWindow):
    ...
    # New classes
    from my_idlelib.history import History
    ...
    def open_stack_viewer(self, event=None):
        ...
        try:
            ...
            messagebox.showerror("No stack trace",
                ...
                parent=self.text)
            return
        from my_idlelib.stackviewer import StackBrowser
...
def main():
    ...
    from my_idlelib import testing  # bool value
