...
from my_idlelib.squeezer import count_lines_with_wrapping, ExpandingButton, \
    Squeezer
from my_idlelib import macosx
from my_idlelib.textview import view_text
from my_idlelib.tooltip import Hovertip
from my_idlelib.pyshell import PyShell
...
class ExpandingButtonTest(unittest.TestCase):
    ...
    @patch('my_idlelib.squeezer.Hovertip', autospec=Hovertip)
    ...
    def test_expand_dangerous_oupput(self):
        ...
        with patch('my_idlelib.squeezer.messagebox') as mock_msgbox:
    ...
    def test_view(self):
        ...
        with patch('my_idlelib.squeezer.view_text', autospec=view_text)\
                as mock_view_text:
