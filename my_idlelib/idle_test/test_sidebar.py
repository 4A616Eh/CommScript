...
from my_idlelib.delegator import Delegator
...
class LineNumbersTest(unittest.TestCase):
    ...
    def setUp(self):
        self.linenumber = my_idlelib.sidebar.LineNumbers(self.editwin)

        self.highlight_cfg = {"background": '#abcdef',
                              "foreground": '#123456'}
        orig_idleConf_GetHighlight = my_idlelib.sidebar.idleConf.GetHighlight
        def mock_idleconf_GetHighlight(theme, element):
            if element == 'linenumber':
                return self.highlight_cfg
            return orig_idleConf_GetHighlight(theme, element)
        GetHighlight_patcher = unittest.mock.patch.object(
            my_idlelib.sidebar.idleConf, 'GetHighlight', mock_idleconf_GetHighlight)
        ...
        GetFont_patcher = unittest.mock.patch.object(
            my_idlelib.sidebar.idleConf, 'GetFont', mock_idleconf_GetFont)
