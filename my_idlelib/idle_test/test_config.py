...
import my_idlelib
from my_idlelib.idle_test.mock_idle import Func
...
def setUpModule():
    ...
    my_idlelib.testing = True

def tearDownModule():
    idleConf.userCfg = usercfg
    my_idlelib.testing = False
...
class IdleConfTest(unittest.TestCase):
    ...
    def test_save_user_cfg_files(self):
        ...
        with mock.patch('my_idlelib.config.IdleUserConfParser.Save') as m:
    ...
    def test_get_option(self):
        ...
        with mock.patch('my_idlelib.config._warn') as _warn:
    ...
    def test_get_highlight(self):
        ...
        with mock.patch('my_idlelib.config._warn'):
...
##        eq(conf.GetExtensionKeys('ZoomHeight'), {'<<zoom-height>>': key})
    ...
    def test_extra_help_source_list(self):
        ...
        conf.userCfg['main'].SetOption('HelpFiles', '1', 'IDLE;C:/Programs/Python36/Lib/ my_idlelib/help.html')
        self.assertEqual(conf.GetExtraHelpSourceList('user'),
                         [('IDLE', 'C:/Programs/Python36/Lib/ my_idlelib/help.html', '1'),
