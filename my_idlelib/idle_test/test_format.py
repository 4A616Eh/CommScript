...
from my_idlelib import format as ft
import unittest
from unittest import mock
from test.support import requires
from tkinter import Tk, Text
from my_idlelib.editor import EditorWindow
from my_idlelib.idle_test.mock_idle import Editor as MockEditor
...
class FindTest(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        from my_idlelib.idle_test.mock_tk import Text
        cls.text = Text()
