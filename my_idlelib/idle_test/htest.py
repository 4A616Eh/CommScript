...
import my_idlelib.pyshell  # Set Windows DPI awareness before Tk().
...
_color_delegator_spec = {
    ...
    'msg': "The text is sample Python code.\n"
           ...
           "The default color scheme is in  my_idlelib/config-highlight.def"
    }
    ...
    if tests:
        ...
        for k, d in globals().items():
            if k.endswith('_spec'):
                ...
                mod = import_module('my_idlelib.' + test_spec['file'])
