...
from my_idlelib.scrolledlist import ScrolledList
from my_idlelib.window import ListedToplevel
...
class Idb(bdb.Bdb):
    ...
    def in_rpc_code(self, frame):
        if frame.f_code.co_filename.count('rpc.py'):
            ...
            if 'my_idlelib' in prev_name and 'debugger' in prev_name:
                # catch both  my_idlelib/debugger.py and  my_idlelib/debugger_r.py
...
if __name__ == "__main__":
    ...
    main('my_idlelib.idle_test.test_debugger', verbosity=2, exit=False)
