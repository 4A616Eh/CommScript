...
# Please be careful not to block main thread, otherwise the GUI will no
# longer work, and you most likely will not be able to exit the program
# without help of the Windows operating system ;-)
...
# scripts may run then! To stop auto-saving close the terminal program
